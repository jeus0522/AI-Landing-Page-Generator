        ...
        <div className="relative pt-2 flex flex-col justify-center items-center">
          ...
          <div className="text-center sm:w-11/12 md:w-[800px]">
            ...
            <h3 className="text-lg text-gray-700 mt-4 tracking-tight">
			  ...
			  <div className="cursor-pointer mt-2 w-full h-10 rounded-full flex justify-center items-center bg-gradient-to-r from-yellow-200 via-green-200 to-blue-200">
                ...
                <div className="flex items-center justify-center space-x-2 bg-gray-200 rounded-xl mx-8 py-1 px-2">
                  ...
                  {isLoading && <span className="ml-4 animate-spin">
					<svg width="20" height="20" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
					    <path fill="none" stroke="#f43f5e" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M5 14a1 1 0 1 0 2 0a1 1 0 0 0-2 0Zm6-2a1 1 0 1 0 2 0a1 1 0 0 0-2 0Zm6-2a1 1 0 1 0 2 0a1 1 0 0 0-2 0Z"/>
					</svg>
				  </span>}
                  <button
                ...
                <button onClick={handleSave}>
                  <span role="img" aria-label="paper-plane">
                    <svg width="20" height="20" viewBox="0 0 32 32" xmlns="http://www.w3.org/2000/svg">
                        <path fill="none" stroke="#000000" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M9 22c-9 1-8-10 0-9C6 2 23 2 22 10c10-3 10 13 1 12m-12 4l5 4l5-4m-5-10v14"/>
                    </svg>
                  </span>
                </button>
